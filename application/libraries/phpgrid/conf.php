...
define('PHPGRID_DB_PASSWORD', 'jackjack'); // database password

define('PHPGRID_DB_NAME', 'bd_tpo'); // database name
...
//define('SERVER_ROOT', '/tpov2/index.php/tpoadminv1/logo/logo/registros'); 
