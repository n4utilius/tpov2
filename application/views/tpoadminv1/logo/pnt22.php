	...
	$(document).ready(function(){
	    ...
	    $('#grid').DataTable({
			...
			columns: [
				...
				{ data: 'id_pnt' },
				{ data: 'id' },
				{ data: 'Partida Genérica' },
				{ data: 'Clave del concepto' },
				{ data: 'Nombre del concepto' },
				{ data: 'Presupuesto Asignado por concepto' },
				{ data: 'Presupuesto Modificado por concepto' },
				{ data: 'Denominacion de cada partida' },
				{ data: 'Presupuesto total asignado a cada partida' },
				{ data: 'Presupuesto modificado por partida' },
				{ data: 'Presupuesto ejercido al periodo reportado de cada partida' },
				{ data: 'estatus_pnt'}
			],
			columnDefs: [ 
				{
