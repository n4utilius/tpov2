	...
	$(document).ready(function(){
	    ...
	    $('#grid').DataTable({
			...
			columns: [
				{ data: 'id_pnt' },
				{ data: 'id' },
				{ data: 'Fecha de firma del contrato' },
				{ data: 'Número o referencia de identificación del contrato' },
				{ data: 'Objeto del contrato' },
				...
				{ data: 'Números de factura' },
				{ data: 'Hipervínculos a la factura' },
